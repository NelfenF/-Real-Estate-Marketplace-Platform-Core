...
namespace Project4.Models
{
    ...
    {
        private static string password = ""; // Brandon Connection PW
        //private static string password = ""; // Nathan Connection PW
        //Main Connection String - used for the published web application and project submissions.
        String SqlConnectString = $"server=cis-mssql1.temple.edu;Database=FA24_3342_;User id=;Password={password};Encrypt=True;TrustServerCertificate=True;";
        //String SqlConnectString = $"server=cis-mssql1.temple.edu;Database=FA24_3342_;User id=;Password={password}Encrypt=True;TrustServerCertificate=True;;"; // Brandon connection string
        //String SqlConnectString = $"server=cis-mssql1.temple.edu;Database=FA24_3342_;User id=;Password={password}"; // Nathan connection string

        // Home Connection String - used for working from home using SSH Tunneling.
        //String SqlConnectString = $"server=127.0.0.1,5555;Database=FA24_3342_;User id=;Password={password};Encrypt=True;TrustServerCertificate=True;"; // Brandon home connection
        //String SqlConnectString = $"server=127.0.0.1,5555;Database=FA24_3342_;User id=;Password={password};Encrypt=True;TrustServerCertificate=True;"; // Nathan home connection
